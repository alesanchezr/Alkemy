                ...
                <section className="wrap alk-container my-4">
                    <Row className="align-items-center h-100">
                        <Col xs={12}>
                            ...
                            <p>
                                Redistribute content from Alkemy, Inc (unless
                            ...
                            <ol>
                                ...
                                <li>
                                    ...
                                    the views or opinions ofAlkemy, Inc, its
                                    agents or affiliates. Comments reflect the
                                    view and opinion of the person who posts
                                    such view or opinion. To the extent
                                    permitted by applicable laws Alkemy,
                                    Incshall not be responsible or liable for
                                    the Comments or for any loss cost,
                                ...
                                <li>
                                    Alkemy, Increserves the right to monitor all
                                    Comments and to remove any Comments which it
                                    considers in its absolute discretion to be
                                    inappropriate, offensive or otherwise in
                                ...
                                <li>
                                    You hereby grant to{" "}
                                    <strong>Alkemy, Inc</strong> a non-exclusive
                                    royalty-free license to use, reproduce, edit
                                    and authorize others to use, reproduce and
                                    edit any of your Comments in any and all
                            ...
                            <p>
                                ...
                                right to amend these terms and conditions and
                                its linking policy at any time. By continuing to
